...
class TextField: MDCTextField, UITextFieldDelegate, Validatable {
    ...
    var floatingController: MDCTextInputControllerFloatingPlaceholder?
    var underlineController: MDCTextInputControllerUnderline?
